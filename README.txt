...
the silos depending on the status of their ammo. When the silo is
green it has above half ammo, when it's yellow it has below half ammo, and
when it turns red it has run out of ammo.
